...
class $UnrecognizedSmsTable extends UnrecognizedSms
    with TableInfo<$UnrecognizedSmsTable, UnrecognizedSm> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $UnrecognizedSmsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _unrecognizedSmsPkMeta =
      const VerificationMeta('unrecognizedSmsPk');
  @override
  late final GeneratedColumn<String> unrecognizedSmsPk =
      GeneratedColumn<String>('unrecognized_sms_pk', aliasedName, false,
          type: DriftSqlType.string,
          requiredDuringInsert: false,
          clientDefault: () => uuid.v4());
  ...
  late final GeneratedColumn<bool> handled = GeneratedColumn<bool>(
      ...
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("handled" IN (0, 1))'),
      defaultValue: const Constant(false));
  @override
  List<GeneratedColumn> get $columns =>
      [unrecognizedSmsPk, sender, body, dateCreated, dateTimeModified, handled];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'unrecognized_sms';
  @override
  VerificationContext validateIntegrity(Insertable<UnrecognizedSm> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('unrecognized_sms_pk')) {
      context.handle(
          _unrecognizedSmsPkMeta,
          unrecognizedSmsPk.isAcceptableOrUnknown(
              data['unrecognized_sms_pk']!, _unrecognizedSmsPkMeta));
    }
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {unrecognizedSmsPk};
  @override
  UnrecognizedSm map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UnrecognizedSm(
      unrecognizedSmsPk: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}unrecognized_sms_pk'])!,
      ...
      handled: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}handled'])!,
    );
  }

  @override
  $UnrecognizedSmsTable createAlias(String alias) {
    return $UnrecognizedSmsTable(attachedDatabase, alias);
  }
}

class UnrecognizedSm extends DataClass implements Insertable<UnrecognizedSm> {
  final String unrecognizedSmsPk;
  final String sender;
  final String body;
  final DateTime dateCreated;
  final DateTime? dateTimeModified;
  final bool handled;
  const UnrecognizedSm(
      {required this.unrecognizedSmsPk,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['unrecognized_sms_pk'] = Variable<String>(unrecognizedSmsPk);
  ...
  UnrecognizedSmsCompanion toCompanion(bool nullToAbsent) {
    return UnrecognizedSmsCompanion(
      unrecognizedSmsPk: Value(unrecognizedSmsPk),
      sender: Value(sender),
      body: Value(body),
      dateCreated: Value(dateCreated),
      dateTimeModified: dateTimeModified == null && nullToAbsent
  ...
  factory UnrecognizedSm.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return UnrecognizedSm(
      unrecognizedSmsPk: serializer.fromJson<String>(json['unrecognizedSmsPk']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'unrecognizedSmsPk': serializer.toJson<String>(unrecognizedSmsPk),
  ...
  UnrecognizedSm copyWith(
          {String? unrecognizedSmsPk,
          String? sender,
          String? body,
          DateTime? dateCreated,
          Value<DateTime?> dateTimeModified = const Value.absent(),
          bool? handled}) =>
      UnrecognizedSm(
        unrecognizedSmsPk: unrecognizedSmsPk ?? this.unrecognizedSmsPk,
  ...
  UnrecognizedSm copyWithCompanion(UnrecognizedSmsCompanion data) {
    return UnrecognizedSm(
      unrecognizedSmsPk: data.unrecognizedSmsPk.present
          ? data.unrecognizedSmsPk.value
          : this.unrecognizedSmsPk,
  ...
  @override
  String toString() {
    return (StringBuffer('UnrecognizedSm(')
          ..write('unrecognizedSmsPk: $unrecognizedSmsPk, ')
          ..write('sender: $sender, ')
          ..write('body: $body, ')
          ..write('dateCreated: $dateCreated, ')
          ..write('dateTimeModified: $dateTimeModified, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UnrecognizedSm &&
          other.unrecognizedSmsPk == this.unrecognizedSmsPk &&
...
class UnrecognizedSmsCompanion extends UpdateCompanion<UnrecognizedSm> {
  final Value<String> unrecognizedSmsPk;
  ...
  final Value<int> rowid;
  const UnrecognizedSmsCompanion({
    this.unrecognizedSmsPk = const Value.absent(),
  ...
  UnrecognizedSmsCompanion.insert({
    this.unrecognizedSmsPk = const Value.absent(),
    ...
    this.rowid = const Value.absent(),
        ...
        body = Value(body);
  static Insertable<UnrecognizedSm> custom({
    Expression<String>? unrecognizedSmsPk,
    ...
    return RawValuesInsertable({
      if (unrecognizedSmsPk != null) 'unrecognized_sms_pk': unrecognizedSmsPk,
  ...
  UnrecognizedSmsCompanion copyWith(
      {Value<String>? unrecognizedSmsPk,
      Value<String>? sender,
      Value<String>? body,
      Value<DateTime>? dateCreated,
      Value<DateTime?>? dateTimeModified,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (unrecognizedSmsPk.present) {
      map['unrecognized_sms_pk'] = Variable<String>(unrecognizedSmsPk.value);
    }
    if (sender.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('UnrecognizedSmsCompanion(')
          ..write('unrecognizedSmsPk: $unrecognizedSmsPk, ')
          ..write('sender: $sender, ')
          ..write('body: $body, ')
          ..write('dateCreated: $dateCreated, ')
...
abstract class _$FinanceDatabase extends GeneratedDatabase {
  ...
  late final $UnrecognizedSmsTable unrecognizedSms =
      $UnrecognizedSmsTable(this);
  @override
...
typedef $$DeleteLogsTableProcessedTableManager = ProcessedTableManager<
    ...
    DeleteLog,
    PrefetchHooks Function()>;
typedef $$UnrecognizedSmsTableCreateCompanionBuilder = UnrecognizedSmsCompanion
    Function({
  Value<String> unrecognizedSmsPk,
  required String sender,
  required String body,
...
typedef $$UnrecognizedSmsTableUpdateCompanionBuilder = UnrecognizedSmsCompanion
    Function({
  Value<String> unrecognizedSmsPk,
  Value<String> sender,
  Value<String> body,
...
class $$UnrecognizedSmsTableFilterComposer
    extends Composer<_$FinanceDatabase, $UnrecognizedSmsTable> {
  $$UnrecognizedSmsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get unrecognizedSmsPk => $composableBuilder(
      column: $table.unrecognizedSmsPk,
      builder: (column) => ColumnFilters(column));
...
class $$UnrecognizedSmsTableOrderingComposer
    extends Composer<_$FinanceDatabase, $UnrecognizedSmsTable> {
  $$UnrecognizedSmsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get unrecognizedSmsPk => $composableBuilder(
      column: $table.unrecognizedSmsPk,
      builder: (column) => ColumnOrderings(column));
...
class $$UnrecognizedSmsTableAnnotationComposer
    extends Composer<_$FinanceDatabase, $UnrecognizedSmsTable> {
  $$UnrecognizedSmsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get unrecognizedSmsPk => $composableBuilder(
      column: $table.unrecognizedSmsPk, builder: (column) => column);
...
class $$UnrecognizedSmsTableTableManager extends RootTableManager<
    _$FinanceDatabase,
    $UnrecognizedSmsTable,
    UnrecognizedSm,
    $$UnrecognizedSmsTableFilterComposer,
    $$UnrecognizedSmsTableOrderingComposer,
    $$UnrecognizedSmsTableAnnotationComposer,
    $$UnrecognizedSmsTableCreateCompanionBuilder,
    $$UnrecognizedSmsTableUpdateCompanionBuilder,
    (
      UnrecognizedSm,
      BaseReferences<_$FinanceDatabase, $UnrecognizedSmsTable, UnrecognizedSm>
    ),
    UnrecognizedSm,
    PrefetchHooks Function()> {
  $$UnrecognizedSmsTableTableManager(
      _$FinanceDatabase db, $UnrecognizedSmsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$UnrecognizedSmsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$UnrecognizedSmsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$UnrecognizedSmsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> unrecognizedSmsPk = const Value.absent(),
            ...
            Value<int> rowid = const Value.absent(),
              ...
              UnrecognizedSmsCompanion(
            unrecognizedSmsPk: unrecognizedSmsPk,
            sender: sender,
            body: body,
            dateCreated: dateCreated,
            dateTimeModified: dateTimeModified,
...
typedef $$UnrecognizedSmsTableProcessedTableManager = ProcessedTableManager<
    _$FinanceDatabase,
    $UnrecognizedSmsTable,
    UnrecognizedSm,
    $$UnrecognizedSmsTableFilterComposer,
...
class $FinanceDatabaseManager {
  ...
  $$UnrecognizedSmsTableTableManager get unrecognizedSms =>
      $$UnrecognizedSmsTableTableManager(_db, _db.unrecognizedSms);
}
